                ...
                <ul className="about-me-container">
                    <li className="about-me-item">
                      <h3>About Me</h3>
                        ...
                        <p>I've built several full-stack single page web applications in React/Redux and Node/Express (see portfolio section for more detail).</p>
                        ...
                        <p>I'm currently working as a freelance front end engineer for an ecommerce marketing company, and am open to both part-time, full-time, and contract based opportunities.</p>
