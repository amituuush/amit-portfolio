            ...
            <section className="about-me-section">
                <ul className="about-me-container">
                    <li className="about-me-item">
                        ...
                        <p>I recently graduated from <a href="https://www.thinkful.com/" target="_blank">Thinkful</a>'s coding bootcamp and am looking to join a fun and passionate company. I enjoy using my development experience to help companies solve business problems. I also have design experience, which you can check out <a href="https://www.behance.net/rananamit20cb" target="_blank">here</a>.</p>
