                ...
                <ul className="about-me-container">
                    <li className="about-me-item">
                          <h3>About Me</h3>
                            ...
                            <p>I'm a front end React/Redux developer skilled in developing responsive and functional SPA's while finding solutions to front end problems. I have working knowledge of Node.js, Express, MongoDB, and Mongoose.js. I also have 2 years of UI/UX development experience at startups, one of which was in the startup accelerator, 500 Startups. You can check out my design portfolio <a href="https://www.behance.net/rananamit20cb" target="_blank">here</a>. I'm passionate about the constantly evolving world of tech, and I love working on personal projects and learning new technologies in order to build beautiful and intuitive user experiences.</p>
                          ...
                          <p>I've designed and developed countless responsive and mobile first interfaces for a team gaming platform application and an app that got people out of their cell phone contracts without paying early termination fees (while working at Isometry Labs and CellBreaker).</p><br />
                          ...
                          <p>I'm currently working as a freelance front end React developer for an ecommerce marketing company, which ends in January, and am looking to join a passionate and mission driven company while working in React/Redux.</p>
